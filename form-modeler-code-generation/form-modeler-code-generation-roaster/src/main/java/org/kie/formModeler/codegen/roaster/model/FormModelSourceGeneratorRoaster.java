package org.kie.formModeler.codegen.roaster.model;
 ...
 */
@ApplicationScoped
public class FormModelSourceGeneratorRoaster implements FormModelSourceGenerator {
    ...
    public String generateFormModelSource( SourceGenerationContext context ) {
        ...
        for ( DataHolder dataHolder : context.getFormDefinition().getDataHolders() ) {
            ...
            if ( ArrayUtils.contains( BASIC_TYPES, dataHolder.getType() ) ) {
